// Portfolio Website JavaScript - Enhanced and Modern
...
function initScrollEffects() {
    ...
    const animateElements = document.querySelectorAll('.about-text, .detail-item, .stat, .timeline-item, .skill-category, .project-card, .contact-item');
